...
# === SOLO CAMBIA ESTO PARA GANGABET ===
HEADERS = {
...
PARAMS_EVENTS = {
    "culture": "es-ES",
    "timezoneOffset": "300",
    "integration": "gangabet.pe",   # <- según tu link
    "deviceType": "1",
    "numFormat": "en-GB",
    "countryCode": "PE",
    "sportids": "66"
...
LIGAS_EQUIVALENCIAS = [
    ...
    ("Championship Eng.", "Inglaterra", "Championship"),
    ...
    ("DFB Pokal - Copa Alemania", "Alemania", "Copa Alemana"),
...
def obtener_cuotas(event_id: int):
    params = {
        "culture": "es-ES",
        "timezoneOffset": "300",
        "integration": "gangabet.pe",   # <- GANGABET
        "deviceType": "1",
        "numFormat": "en-GB",
        "countryCode": "PE",
